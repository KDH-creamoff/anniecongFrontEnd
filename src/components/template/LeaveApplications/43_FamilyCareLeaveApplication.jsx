...
const FamilyCareLeaveApplication = ({ pdfRef }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    delegateApprover: '',
    urgentApprover: '',
    noticeText: '상기 본인은 위와 같이 2025년도 가족돌봄휴가를 신청하오니 처리하여 주시기 바랍니다.',
    year: '20',
    month: '',
    day: '',
    applicantName: '',
    ...
    <>
      ...
      <div ref={contentRef} className="w-full max-w-[800px] mx-auto p-8 bg-white">
        ...
        <div className="flex justify-between items-start mb-6">
          <h1 className="text-3xl font-bold">가족돌봄휴가 신청서</h1>
...
export default FamilyCareLeaveApplication;
