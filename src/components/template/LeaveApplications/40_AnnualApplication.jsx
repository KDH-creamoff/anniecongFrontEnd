...
const AnnualApplication = ({ pdfRef }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    delegateApprover: '',
    urgentApprover: '',
    noticeText: '상기 본인은 위와 같이 2025년도 연차를 신청하오니 처리하여 주시기 바랍니다.',
    year: '20',
    month: '',
    day: '',
    applicantName: '',
    ...
    <>
      ...
      <div ref={contentRef} className="w-full max-w-[800px] mx-auto p-8 bg-white">
        ...
        <div className="flex justify-between items-start mb-6">
          <h1 className="text-3xl font-bold">연차 신청서</h1>
        ...
        <table className="w-full border-2 border-black border-collapse mb-4">
          <tbody>
            <tr>
              <td className="border-2 border-black px-4 py-3 text-center font-bold text-sm" style={{ width: '100px' }} rowSpan={2}>
                인적사항
              </td>
                ...
                <div className="flex flex-col items-center justify-center">
                  <div className="flex items-center gap-1 mb-1">
                    <input
                      ...
                      className="w-8 outline-none text-center font-bold"
                      placeholder="20"
                    />
                    <span>년도</span>
                  </div>
...
export default AnnualApplication;
