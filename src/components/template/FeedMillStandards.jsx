  ...
  return (
    <div className="mx-auto max-w-4xl bg-white p-8">
          ...
          <tbody>
            ...
            <tr style={{height: '35px'}}>
              ...
              <td className="border border-black text-sm" style={{verticalAlign: 'middle', padding: '4px', lineHeight: '1'}}>
                <span style={{display: 'inline-block', verticalAlign: 'middle'}}>문서번호:</span>
                <input
                  type="text"
                  ...
                  style={{verticalAlign: 'middle', width: 'calc(100% - 70px)', display: 'inline-block', lineHeight: '1', padding: '0', margin: '0'}}
                />
              </td>
            </tr>
            <tr style={{height: '35px'}}>
              <td className="border border-black text-sm" style={{verticalAlign: 'middle', padding: '4px', lineHeight: '1'}}>
                <span style={{display: 'inline-block', verticalAlign: 'middle'}}>페이지:</span>
                <input
                  type="text"
                  value={headerInfo.pageNumber}
                  onChange={(e) => handleHeaderChange("pageNumber", e.target.value)}
                  className="border-0 outline-none bg-transparent text-sm"
                  style={{verticalAlign: 'middle', width: 'calc(100% - 55px)', display: 'inline-block', lineHeight: '1', padding: '0', margin: '0'}}
                />
              </td>
            </tr>
            ...
            <tr style={{height: '35px'}}>
              ...
              <td className="border border-black text-sm" style={{verticalAlign: 'middle', padding: '4px', lineHeight: '1'}}>
                <span style={{display: 'inline-block', verticalAlign: 'middle'}}>개정일자:</span>
                <input
                  type="text"
            ...
            <tr style={{height: '35px'}}>
              <td className="border border-black text-sm" style={{verticalAlign: 'middle', padding: '4px', lineHeight: '1'}}>
                <span style={{display: 'inline-block', verticalAlign: 'middle'}}>개정번호:</span>
                <input
                  type="text"
        ...
        <table className="w-full border-collapse" style={{tableLayout: 'fixed', borderCollapse: 'collapse'}}>
          <thead>
            <tr style={{height: '24px'}}>
              <th className="border border-black bg-gray-100 text-xs" style={{verticalAlign: 'middle', width: '60px', padding: '2px', lineHeight: '1'}}>개정번호</th>
              <th className="border border-black bg-gray-100 text-xs" style={{verticalAlign: 'middle', padding: '2px', lineHeight: '1'}}>제·개정 일자</th>
              <th className="border border-black bg-gray-100 text-xs" style={{verticalAlign: 'middle', padding: '2px', lineHeight: '1'}}>제·개정 사유</th>
              <th colSpan={2} className="border border-black bg-gray-100 text-xs" style={{verticalAlign: 'middle', padding: '2px', lineHeight: '1'}}>제·개정 내용 요약</th>
            </tr>
          </thead>
          <tbody>
            {revisionHistory.map((item, idx) => (
              <tr key={idx} style={{height: '26px'}}>
                <td className="border border-black text-center text-sm" style={{verticalAlign: 'middle', padding: '2px', lineHeight: '1'}}>
                  {idx + 1}
                </td>
      ...
      <PdfDownloadButton
        ...
        buttonText="PDF 다운로드"
        className="mt-20 bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded transition-colors"
      />
    </div>
  );
};
